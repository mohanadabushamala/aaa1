...
public class MainActivity extends AppCompatActivity {
    ...
    private void addContactDialog() {
        ...
        EditText name = dialogView.findViewById(R.id.nameE);
        EditText phoneNum = dialogView.findViewById(R.id.phoneNE);
        EditText address = dialogView.findViewById(R.id.addressE);
        Button saveButton = dialogView.findViewById(R.id.saveB);
